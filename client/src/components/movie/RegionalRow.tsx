      ...
      <div className="flex items-center justify-between mb-4 px-4 md:px-8 relative z-20">
        <div className="flex items-center gap-3 relative" ref={dropdownRef}>
          ...
          <button
            ...
            className={`flex items-center gap-1.5 md:px-4 md:py-2 px-2 py-1 rounded-xl backdrop-blur-md border transition-all duration-300 shadow-lg ${activeTheme.bgLight} ${activeTheme.border} ${activeTheme.primary} hover:bg-white/10`}
          >
          ...
          {/* Native Tailwind Dropdown */}
          {isDropdownOpen && (
            <div 
              className="absolute top-full left-0 mt-3 w-44 bg-[#0a0514]/90 backdrop-blur-xl border border-white/10 rounded-2xl shadow-[0_20px_40px_rgba(0,0,0,0.5)] overflow-hidden z-30 animate-in fade-in zoom-in-95 duration-200 origin-top-left"
            >
        ...
        >
          {currentItems
            ...
            .map((item) => {
              ...
              // Both Bollywood and Hollywood are movies
