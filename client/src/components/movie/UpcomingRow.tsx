...
// Dynamic Theme Configurations - Emerald/Teal for "Upcoming"
const THEME = {
  movie: {
...
export default function UpcomingRow({ upcomingMovies, upcomingTV }: UpcomingRowProps) {
  ...
  return (
    <section className="relative group/row py-6 overflow-hidden">
      ...
      <div className="absolute top-0 right-10 w-96 h-96 rounded-full blur-[120px] pointer-events-none bg-emerald-600/5" />
