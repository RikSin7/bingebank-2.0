    ...
    <section className="relative group/row py-6 overflow-hidden">
      ...
      <div className="flex items-center justify-between mb-4 px-4 md:px-8 relative z-20">
        ...
        <div className="flex items-center gap-3 relative" ref={dropdownRef}>
          ...
          {isDropdownOpen && (
            <div 
              className="absolute top-full left-[110px] mt-3 w-44 bg-[#0a0514]/90 backdrop-blur-xl border border-white/10 rounded-2xl shadow-[0_20px_40px_rgba(0,0,0,0.5)] overflow-hidden z-30 animate-in fade-in zoom-in-95 duration-200 origin-top-left"
            >
